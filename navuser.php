...
<?php
    ...
    if(isset($_SESSION['k1']))
    {
        ...
        $user=$_SESSION['k1'];
        $q="select * from customer where Mobile='$user'";
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <li class="nav-item"><a class="nav-link" href="index user.php">Home</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="user.php">Apply loan</a></li>
                        <li class="nav-item"><a class="nav-link" href="viewemi.php">View EMI</a></li>
                        <li class="nav-item"><a class="nav-link" href="usermessage.php">Talk to Admin</a></li>
